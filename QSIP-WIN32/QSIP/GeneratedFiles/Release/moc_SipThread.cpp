...
QT_MOC_LITERAL(1, 10, 12), // "Label_Stauts"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "str"
QT_MOC_LITERAL(4, 28, 9), // "Label_Reg"
QT_MOC_LITERAL(5, 38, 11), // "Button_Dial"
QT_MOC_LITERAL(6, 50, 10), // "Button_Reg"
QT_MOC_LITERAL(7, 61, 12), // "Button_Unreg"
QT_MOC_LITERAL(8, 74, 11) // "Button_Hang"

    },
    "SipThread\0Label_Stauts\0\0str\0Label_Reg\0"
...
void SipThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Label_Stauts((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->Label_Reg((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (SipThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SipThread::Label_Stauts)) {
                *result = 0;
            }
        }
        {
...
// SIGNAL 0
void SipThread::Label_Stauts(const QString & _t1)
{
...
// SIGNAL 1
void SipThread::Label_Reg(const QString & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
